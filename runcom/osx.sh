...
# Add keyboard shortcuts to manage windows
defaults write -g NSUserKeyEquivalents -dict-add "Move Window to Left Side of Screen" "@^l"
defaults write -g NSUserKeyEquivalents -dict-add "Move Window to Right Side of Screen" "@^r"
defaults write -g NSUserKeyEquivalents -dict-add "Tile Window to Left of Screen" "@^\U2190"
defaults write -g NSUserKeyEquivalents -dict-add "Tile Window to Right of Screen" "@^\U2192"
...
# Remove recently used apps in separate section of the Dock
